  ...
  return (
    <div id="filter-buttons" className="row">
      <div id="btn-filters" className="">
        <a id="all" href=" " className="filter-btn active" onClick={e => props.handleClick} data-filter="all">All</a>
        <a id="react" href=" " className="filter-btn" onClick={e=>props.handleClick} data-filter="reactjs">React</a>
