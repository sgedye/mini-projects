...
export default [
  ...
  { id: 6, title: "Pomodoro Timer",   img: pomodoro,  alt: "Pomodoro Timer",    desc: "React, Hooks, Styled-Components, React-Icons, CSS", onGitHub: true, address: "pomodoro" },
  ...
  { id: 8, title: "Budget App",       img: budget,    alt: "Budget Application", desc: "JavaScript, HTML, Bootstrap, CSS", onGitHub: true, address: "budget-app" },
  { id: 9, title: "Clock",            img: clock,     alt: "CSS & JS Clock",    desc: "JavaScript, HTML, CSS", onGitHub: true, address: "clock" },
  { id: 10, title: "Grandmas Sweets", img: grandmas,  alt: "Grandmas Sweets",   desc: "HTML, CSS, JavaScript", onGitHub: true, address: "grandmas-sweets" },
  { id: 11, title: "Slideshow",       img: slideshow, alt: "Slideshow with Autoplay", desc: "JavaScript, HTML, CSS", onGitHub: true, address: "slideshow" },
  { id: 12, title: "Drag 'n' Drop",   img: dragDrop,  alt: "Drag 'n' Drop",     desc: "React, HTML, CSS", onGitHub: true, address: "drag-n-drop" },
  { id: 13, title: "Quote Machine",   img: quotes,    alt: "Quote Machine",     desc: "React, HTML, SCSS", onGitHub: true, address: "quotes" },
  { id: 14, title: "SVG Writing",     img: svgWriting, alt: "SVG Writing",      desc: "HTML, CSS", onGitHub: true, address: "svg-writing" },
  { id: 15, title: "React Counter",   img: counter,   alt: "React Counter",     desc: "React, HTML, CSS", onGitHub: true, address: "counter" },
];